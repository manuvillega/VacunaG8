...
public class VacunaVista extends javax.swing.JPanel {
    ...
    private String[] marcas={"Moderna", "Pfizer","Aztrazeneca" ,"Sinopharm" ,"Sputnik" };
...
//BOTON BUSCAR    
    private void jButton2_BuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2_BuscarActionPerformed
        ...
        if (vacunaEncontrada != null) {
            ...
            }JOptionPane.showMessageDialog(this, "pasaste el combo marca");                
...
//BOTON MODIFICAR    
    private void jButton3_ModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3_ModificarActionPerformed
        ...
        if (vacunaEncontrada != null) {
            jComboBox1_Marca.setSelectedItem(vacunActual.getMarca());
            for (int i = 0; i < jComboBox1_Marca.getItemCount(); i++) {
                if (vacunActual.getMarca().equals(jComboBox1_Marca.getItemAt(i))) {
                    jComboBox1_Marca.setSelectedIndex(i);
                    break;
                }
            }
            jComboBox2_Medida.setSelectedItem(vacunActual.getMedida());
            for (int i = 0; i < jComboBox2_Medida.getItemCount(); i++) {
                if (vacunActual.getMedida() == (Double.valueOf(jComboBox2_Medida.getItemAt(i)))) {
                    jComboBox2_Medida.setSelectedIndex(i);
                    break;
                }
            }
            jCFechaCad.setDate(vacunActual.getFechaCaduca());

            if (vacunaEncontrada.isColocada() == true) {
                JRadioButton jRadioButtonSi1 = jRadioButtonSi;
                boolean colocada = true;
            } else {
                JRadioButton jRadioButtonNo1 = jRadioButtonNo;
    ...
    private void jButton4_EliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4_EliminarActionPerformed
        ...
        if (vacunaEncontrada != null) {
            ...
            if (colocada == true) {
                ...
                vacunaData.eliminarVacuna(vacunaEncontrada);

            } else {
                System.out.println("La vacuna esta activa, no ha sido colocada");
            }
...
//        String[] marcas = {"Moderna", "Pfizer","Aztrazeneca" ,"Sinopharm" ,"Sputnik" };
//        jComboBox1_Marca<String> combobox = new jComboBox1_Marca<>(marcas);
//    }
//
//    private void cargarComboMedida() {
//        jComboBox2_Medida.addItem("0.3");
//        jComboBox2_Medida.addItem("0.5");
//        jComboBox2_Medida.addItem("0.9");
//    }
//    // Creamos un arreglo de nombres
//        String[] nombres = {"Nombre1", "Nombre2", "Nombre3", "Nombre4", "Nombre5"};
//        
//        // Creamos un JComboBox y lo poblamos con los nombres
