...
public class LaboratorioVista extends javax.swing.JPanel {
    ...
    private void jBAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBAgregarActionPerformed
        ...
        String sql = "INSERT INTO Laboratorio (CUIT, nomLaboratorio, pais, domComercial) VALUES (20298554446, Moderna, Argentina, Liniers 35)";
    ...
    private void jBModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBModificarActionPerformed
        ...
        if (id != 0) {
            ...
            if (laboratorio != null) {
                ...
                laboratorio = new Laboratorio(id, cuit, nomLaboratorio, pais, domComercial);
                laboratoriodata.actualizarLaboratorio(laboratorio);
            } else {
                JOptionPane.showMessageDialog(this, "No existe un laboratorio con ese ID");
            }
        } else {
